...
def main():
    parser = argparse.ArgumentParser(description="Real-world Inference: Crop Map -> Predict -> Save.")
    parser.add_argument("--weights", type=str, required=True, default="weights/cryoligate_v1.0.0.pth", help="Path to trained weights")
